                    ...
                    <div id='aboutBody'>
                        ...
                        <div id='aboutContainer' className='flex-col margin-auto'>
                            ...
                            <div className='flex about-timeline'>
                                ...
                                <Accordion years={['2025 ~','2024 ~ 2025','2021 ~ 2022', '2021.07 ~ 2021.10','2020~2021', '2020']} 
                                organizations={['재직회사 비공개','STUDIO KIO','CJ 올리브영','아모레퍼시픽', '유비크코리아', '현대기획사']} 
                                descriptions={['브랜드디자이너','그래픽디자이너','미디어커머스팀 웹디자이너', '카운셀러 TF팀 | 단기계약직', '웹디자이너', '-']} />

                            </div>
                            <div className='flex about-timeline'>
                                <div className='collapse-title'>Project</div>
                                <Accordion years={['2025.08 ~ 2025.09 | 1M','2024.10 ~ 2024.11 | 1M','2024.08 ~ 2024.09 | 1M','2024.03 ~ 2024.09 | 6M','2024.05 ~ 2024.06 | 1M','2023.11 ~ 2024.06 | 1M','2024.04 ~ 2024.05 | 1M','2024.08 ~ 2024.10 | 2M','2023.08~2023.11 | 3M','2023.05 ~ 2023.06','2023.10 ~ 2023.11','2023.04 ~ 2023.05 | 1M', '2022.08 ~ 2022.12 | 4M', 
                                ...
                                organizations={['그리드쉬프트','HONO 24winter','ORGD 굿디자이너:대답','되고파너의최대부적','한솔홈데코 이지셀프 브랜딩','나의바다 아트북 펀딩','경희대 의상학과 패션필름','HONO 23f/w','Mpound','동덕여대 패션쇼 K.V','SKT 윤리경영실 BX', '잉클 콘텐츠 마케팅','Exhibition WWW', 
                                '칵테일레시피 북 편테일바', '패스트캠퍼스 UXUI KDT', '직장인 부트캠프 창',
                                '심리테스트 호텔쉼쉼', 'SBS 애니갤러리','Ozel 웹사이트 구축','OFF 패션화보 Freedom','청년인생설계학교','OFF 패션필름 [?]']} 
                                descriptions={['그래픽전시','그래픽디자인','그래픽전시','브랜드 디자인','브랜드 전략기획','일러스트 개인펀딩','비디오그래퍼','그래픽 디자인','BX디자인','그래픽 총괄', '그래픽 디자인', '마케팅 & 콘텐츠 디자인', '주최 & 총괄감독', '기획 & 그래픽','UIUX 리드', 'PM & UIUX', '크리에이티브 디렉터','696화 POP방영','최종 디자인채택 및 납품','4팀 리더 & 경쟁PT','영상기획 & 콘텐츠디자인','2팀 비디오 에디터']} />
                            </div>
                            <div className='flex about-timeline'>
                            ...
                            <div className='flex about-timeline'>
                                ...
                                <Accordion years={['2021.07 ~','2025.12','2025.08','2025.08','2025.08','2025.05 ~ 2025.06','2025.03 ~ 2025.05','2025.02 ~ 2025.03','2025.02 ~ 2025.03','2025.02','2024.12 ~ 2024.01','2024.12.08','2024.10 ~ 2024.12','2024.10 ~ 2024.12','2024.10.05','2024.07 ~ 2025.06','2024.09 ~ 2024.11','2024.09 ~ 2024.10','2024.09.21','2024.08 ~ 2024.09','2024.07 ~ 2024.08','2024.07 ~ 2024.08','2024.07.28','2024.07.27','2024.06 ~ 2024.07','2024.05 ~ 2024.06','2024.05 ~ 2024.06','2024.04 ~','2024.02 ~ 2024.03','2023.11 ~ 2023.12','2023.10 ~ 2023.11','2023.10.23','2023.05 ~ 2023.06','2023.05.30','2023.03 ~ 2023.11','2023.01 ~ 2023.02', '2022.08.22','2022.03 ~ 2022.08','2021.04 ~ 2022.04 | 1Y','2021.05.17','2021.12 ~ 2022.01','2021.03 ~ 2021.05','2020.07 ~ 2020.10','2019.10.23']} 
                                organizations={['OOBB Crew','북 박스 워크숍','Mini ArtBook','코너버리 튜토리얼','김유림의 제책실험실 21기','지금아트북을만들자','패션BX 워크숍','레터링2 실무','타이포그래피 6기','북바인딩 워크숍','레터링 워크숍','꼴의 힘','CHI 서포터즈','엔터테이먼트 그래픽','VASE 리소 워크숍','대한출판협회 서포터즈','라틴타입 디자인','편집디자인 워크숍','서울레코드페어','레터링 워크숍','레터링 기초','타이포그래피 4기','오이뮤','리소4도 워크숍','리소포스터 워크숍','체인지업','한글 레터링 디자인','AI Designer Club','소장각 클럽','신모래 아트북','비플랫폼 소장각 특강','서울레코드페어','신한커리어업','42회 동덕여대 졸업패션쇼','오설록 티크리에이터','MOTIONLAB','국제 티소믈리에','스파르타 디자인멤버쉽','대학패션연합회 OFF','22회 동덕 미디어졸업전시','sbs아카데미','동덕 졸업전시 준비위원회','메가스터디 아카데미','10회 백석 시각 졸업전시회']} 
                                descriptions={['설립 & 디렉터','바인드썸띵 김명수','Howful','birdcall kiosk','비플랫폼','유어마인드','산산기어 김승민','한글타이포그라피학교','소장각 클럽','바인드썸띵 김명수','Cosmopetype','비상계엄 캠페인','취센스 5기','엄후영 워크숍','Howful','북적북적 1기','한글타이포그라피학교','엠디랩프레스','STAFF3','Cosmopetype','한글타이포그라피학교','소장각 클럽','식물의효능','포푸리','Howful','Season 5','Cosmopetype','1기','타이포그래피 3기','쬐끄만책 5기','타이포그래피 워크숍','STAFF1', '커리어업 3기','패션디자이너','티 크리에이터 2기','c4D bagic lab', '1급','1기','27기 기획팀','UXUI & 애니메이션','MAYA CG','기획팀 전시브랜딩','모션그래픽','헬로인디북스 포스터']} />
                            </div>
                        </div>
                    </div>
