                    ...
                    <div id='aboutBody'>
                        ...
                        <div id='aboutContainer' className='flex-col margin-auto'>
                            ...
                            <div className='flex about-timeline'>
                                ...
                                descriptions={['설립 & 디렉터','비상계엄 캠페인','취센스 5기','엄후영 워크숍','VASE 리소 워크숍','북적북적 1기','라틴타입 디자인','편집디자인3기','STAFF3','레터링 워크숍','레터링 기초','타이포그래피 4기','식물의효능','리소4도 워크숍','리소그래피 워크숍','Season 5','한글 레터링 디자인','1기','타이포그래피 3기','쬐끄만책 5기','타이포그래피 워크숍','STAFF1', '커리어업 3기','패션디자이너','티 크리에이터 2기','c4D bagic lab', '1급','1기','27기 기획팀','UXUI & 애니메이션','MAYA CG','기획팀 전시브랜딩','모션그래픽','헬로인디북스 포스터']} />
                            </div>
                        </div>
                    </div>
